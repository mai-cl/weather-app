...
const TodayDetails = ({ location, current, forecast }) => {
      ...
      >
        <CardContent>
          <Typography component='h1' variant='h5'>
            {name}, {region}, {country}{' '}
            <StyledSpan>As of {moment(last_updated).format('LT')}</StyledSpan>
          </Typography>
        ...
        >
          {details.map(detail => (
            ...
            >
              ...
              />
              <ListItemText primary={detail.value} sx={{ flex: '0 1 auto' }} />
            </ListItem>
          ))}
        </List>
      </Card>
